...
\cite{timing-error}
    ...
    $t_x$ = $a_xt$+ $t_ox$ + $Drift_x(t)$
Where ax is the clock skew i.e., difference between X's oscillator
and the ideal perfect ones and tox is the initial time offset.
Driftx (t) is the clock drift at time t. Clock drift changes with
